...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6377102011:AAHJJ7AUKZhQKcAnHPQtjg9put5mG8vSjEc")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001812749136"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "SexyNano")
